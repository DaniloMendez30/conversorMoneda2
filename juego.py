...
def read_data(filepath="/Users/usuario/Documents/proyecto_ejemplo/venv/archivos/data.txt"):
    words = []
...
def run():
    data = read_data(filepath="/Users/usuario/Documents/proyecto_ejemplo/venv/archivos/data.txt")
